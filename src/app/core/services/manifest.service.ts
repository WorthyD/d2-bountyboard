        ...
        .then((x) => {
          if (x && x.data) {
            ...
            if (x.data.DestinyVendorGroupDefinition) {
              this.vendorGroupService.initializeCache(x.data.DestinyVendorGroupDefinition);
            }
            if (x.data.DestinyInventoryItemDefinition) {
              this.itemService.initializeCache(x.data.DestinyInventoryItemDefinition);
            }
